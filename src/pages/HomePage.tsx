import { BookOpenCheck, Clock3, Flower, Flower2, LockKeyhole, Play, Rabbit, RotateCcw, Shuffle, Star, Trash2 } from 'lucide-react'
...
export function HomePage() {
  ...
  const [settings, setSettings] = useState(false), [discard, setDiscard] = useState(false)
  ...
  return <Layout onSettings={() => setSettings(true)}><main>
    ...
    <section className="paper-card setup">
      ...
      <div className="setup-grid">
        ...
        <fieldset><legend>Options</legend><div className="option-buttons">
