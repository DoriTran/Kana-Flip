...
const preferences: StudyPreferences = { characterSet:'hiragana', reviewMode:'none', reviewMistakesAtEnd:true, shuffled:false, lockNavigation:false, timerMs:null, showKeyboardHints:true, reducedMotion:false }
